...
export default function Navbar() {
  ...
  const SOCIALS = [
    ...
    { label: 'Email', href: 'https://mail.google.com/mail/?view=cm&to=sougandh7ss@gmail.com&su=Hello%20from%20your%20website', icon: <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> },
  ];
