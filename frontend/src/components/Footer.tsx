        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div className="md:col-start-4 space-y-4">
            ...
            <div className="flex gap-4 pt-1">
              <a href="https://github.com/sougandhhhhh" target="_blank" rel="noopener noreferrer" className="text-ghost-white/40 hover:text-ghost-white transition-colors" title="GitHub">
              ...
              <a href="https://linkedin.com/in/sougandhhhhh" target="_blank" rel="noopener noreferrer" className="text-ghost-white/40 hover:text-ghost-white transition-colors" title="LinkedIn">
              ...
              <a href="https://discord.com/users/sougandhhhhh" target="_blank" rel="noopener noreferrer" className="text-ghost-white/40 hover:text-ghost-white transition-colors" title="Discord">
