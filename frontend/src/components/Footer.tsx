        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
          ...
          <div className="md:col-start-4 space-y-3">
            ...
            <div className="flex gap-4 pt-1">
              ...
              <a href="mailto:sougandh7ss@gmail.com" target="_blank" rel="noopener noreferrer" className="text-ghost-white hover:text-ecto-green transition-colors" title="Email">
